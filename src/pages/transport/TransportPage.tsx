          ...
          <Dialog open={routeOpen} onOpenChange={setRouteOpen}>
            ...
            <DialogContent>
              ...
              <form onSubmit={routeForm.handleSubmit(d => routeMutation.mutate(d))} className="space-y-4">
                <div className="space-y-1"><Label>Route Name</Label><Input {...routeForm.register('routeName')} placeholder="North Route" /></div>
            ...
            <DialogContent>
              ...
              <form onSubmit={busForm.handleSubmit(d => busMutation.mutate(d))} className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1"><Label>Bus Number</Label><Input {...busForm.register('busNumber')} placeholder="BUS-001" /></div>
                  <div className="space-y-1"><Label>Capacity</Label><Input type="number" {...busForm.register('capacity')} /></div>
                </div>
                <div className="grid grid-cols-2 gap-4">
                  <div className="space-y-1"><Label>Driver Name</Label><Input {...busForm.register('driverName')} /></div>
                  <div className="space-y-1"><Label>Driver Phone</Label><Input {...busForm.register('driverPhone')} /></div>
                </div>
