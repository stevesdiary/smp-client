  ...
  return (
    <form onSubmit={handleSubmit((d) => mutation.mutate(d))} className="space-y-4">
      <div className="space-y-1">
        <Label>Title</Label>
        <Input {...register('title')} placeholder="Introduction to Mathematics" />
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <div className="space-y-1">
          ...
          <Input type="number" {...register('duration')} placeholder="40" />
        </div>
      </div>
      <div className="space-y-1">
        <Label>Teacher</Label>
    ...
    <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }}>
      <Card className="hover:shadow-md transition-shadow">
        ...
        <CardContent>
          ...
          <Button variant="outline" size="sm" className="w-full" onClick={() => publishMutation.mutate()}>
